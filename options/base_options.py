...
class parser(object):
    def __init__(self):
        ...
        self.image_folder = "/content/gdrive/MyDrive/AI/imaterialist/train/"  # image folder path
        self.df_path = "/content/gdrive/MyDrive/AI/imaterialist/train.csv"  # label csv path
